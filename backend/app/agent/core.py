...
vision_scanner = LlmAgent(
    ...
    instruction=(
        ...
        "2. If the user doesn't specify their name, default to 'Archit'.\n"
        "3. For fridge scans (photos or text), identify items and add them using 'add_to_pantry_tool'.\n"
...
checkout_exporter = LlmAgent(
    ...
    instruction=(
        ...
        "   - Use your own knowledge to determine the ingredients required for each planned meal, scale them for the household size (default: 3 people), subtract any pantry stock already available, and formulate the final shopping checklist.\n"
        ...
        "5. To export to delivery, compile a list of target items (a JSON list of dictionaries, each with 'name', 'amount', 'unit') and call the 'export_to_delivery' tool with the items and provider.\n"
