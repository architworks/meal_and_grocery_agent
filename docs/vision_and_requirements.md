...
| REQ-053 | Mark drafts stale after five minutes without contacting the provider on page entry, focus, or provider switching; require explicit refresh before payment and mandatory revalidation immediately before ordering. | Provider checks must be intentional and visible while stale availability or prices still cannot authorize an order. |
